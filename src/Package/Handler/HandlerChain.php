<?php
namespace Swooen\Package\Handler;
...
abstract class HandlerChain {
    ...
    public function withConnectionFactory(ConnectionFactory $connectionFactory): self {
        $this->app->instance(\Swooen\Package\ConnectionFactory::class, $connectionFactory);
		return $this;
	}
    ...
    public function withHandlerContextHook($implement): self {
        $this->app->bind(\Swooen\Package\Route\Hook\HandlerContextHook::class, $implement);
		return $this;
	}
    ...
    public function withRouteLoader($implement): self {
        $this->app->bind(\Swooen\Package\Route\Loader\RouteLoader::class, $implement);
		return $this;
    }
