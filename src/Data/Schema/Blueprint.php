...
use Closure;
use Swooen\Data\Connection;
use Swooen\Data\Schema\Grammars\Grammar;
use Swooen\Data\SQLiteConnection;
...
class Blueprint
{
     ...
     *
     * @var \Swooen\Data\Schema\ColumnDefinition[]
     */
    protected $columns = [];
     ...
     * @param  string|array  $columns
     * @param  string|null  $name
     * @return \Swooen\Data\Schema\ForeignKeyDefinition
     */
     ...
     *
     * @param  string  $column
     * @return \Swooen\Data\Schema\ColumnDefinition
     */
     ...
     *
     * @param  string  $column
     * @return \Swooen\Data\Schema\ForeignIdColumnDefinition
     */
