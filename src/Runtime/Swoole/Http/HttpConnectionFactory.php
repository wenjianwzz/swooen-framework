...
use Swooen\Runtime\Swoole\Http\HttpConnection;
use Swooen\Runtime\Swoole\Http\Writer\JsonWriter;
...
class HttpConnectionFactory extends SwooleConnectionFactory {
	...
	public function createConnection(\Swoole\Http\Request $sreq, \Swoole\Http\Response $response) {
		...
		$connection->instance(\Swooen\IO\Writer::class, $this->createWriter($response));
		return $connection;
	}
